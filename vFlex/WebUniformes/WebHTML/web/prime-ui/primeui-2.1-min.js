...
var PUI = {
    ...
    calculateScrollbarWidth: function () {
        if (!this.scrollbarWidth) {
            if (this.browser.msie) {
                var c = $('<textarea cols="10" rows="2"></textarea>').css({
                    position: "absolute",
                    top: -1000,
                    left: -1000
                }).appendTo("body"), b = $('<textarea cols="10" rows="2" style="overflow: hidden;"></textarea>').css({
                    position: "absolute",
                    top: -1000,
                    left: -1000
                }).appendTo("body");
    ...
    getGridColumn: function (a) {
        return this.gridColumns[a + ""]
    }
};
PUI.resolveUserAgent();
$(function () {
    $.widget("primeui.puiaccordion", {
        options: {activeIndex: 0, multiple: false}, _create: function () {
            ...
            this.element.children("h3").addClass("pui-accordion-header ui-helper-reset ui-state-default").each(function (c) {
                var f = $(this), e = f.html(), d = (c == a.options.activeIndex) ? "ui-state-active ui-corner-top" : "ui-corner-all", b = (c == a.options.activeIndex) ? "pui-icon fa fa-fw fa-caret-down" : "pui-icon fa fa-fw fa-caret-right";
        ...
        options: {
            ...
            if (this.options.multiple) {
                ...
                if (this.options.dropdown) {
                    this.dropdown = $('<button type="button" class="pui-autocomplete-dropdown pui-button ui-widget ui-state-default ui-corner-right pui-button-icon-only"><span class="pui-icon fa fa-fw fa-caret-down"></span><span class="pui-button-text">&nbsp;</span></button>').insertAfter(this.element);
            ...
            if (this.options.dropdown) {
                this.dropdown.on("mouseenter.puiautocomplete", function () {
                    if (!a.element.prop("disabled")) {
                        a.dropdown.addClass("ui-state-hover")
                    }
                }).on("mouseleave.puiautocomplete", function () {
                    a.dropdown.removeClass("ui-state-hover")
            ...
            this.panel.css({left: "", top: "", width: b, "z-index": ++PUI.zindex}).position({
                my: "left top",
                at: "left bottom",
                of: this.element
            })
...
$(function () {
    $.widget("primeui.puibutton", {
        options: {value: null, icon: null, iconPos: "left", click: null}, _create: function () {
        ...
        options: {
            ...
            if (this.data) {
                for (var a = 0;
                     a < b.length;
                     a++) {
                    var c = this.options.itemContent.call(this, b[a]);
                    if ($.type(c) === "string") {
                        this.element.append("<li>" + c + "</li>")
                    } else {
                        this.element.append($("<li></li>").wrapInner(c))
                    }
                }
            }
            ...
            var a = $(window);
            if (a.width() <= this.options.breakpoint) {
                this.columns = 1;
            ...
            if (b !== this.page && !this.element.is(":animated")) {
                var a = this;
                this.element.animate({left: -1 * (this.viewport.innerWidth() * b), easing: this.options.easing}, {
                    duration: this.options.effectDuration, easing: this.options.easing, complete: function () {
                        a.page = b;
...
$(function () {
    $.widget("primeui.puidatatable", {
        options: {
            ...
            this.element.append('<div class="ui-widget-header pui-datatable-scrollable-header"><div class="pui-datatable-scrollable-header-box"><table><thead></thead></table></div></div>').append('<div class="pui-datatable-scrollable-body"><table><tbody></tbody></table></div></div>');
            ...
            if (this.options.columns) {
                var a = $("<tr></tr>").appendTo(b.thead);
                $.each(this.options.columns, function (d, c) {
                    var e = $('<th class="ui-state-default"><span class="pui-column-title"></span></th>').data("field", c.field).uniqueId().appendTo(a);
                    if (c.headerClass) {
                        e.addClass(c.headerClass)
                    }
                    if (c.headerStyle) {
                        e.attr("style", c.headerStyle)
                    }
                    if (c.headerText) {
                        e.children(".pui-column-title").text(c.headerText)
                    } else {
                        if (c.headerContent) {
                            e.children(".pui-column-title").append(c.headerContent.call(this, c))
                        }
                    }
                    if (c.sortable) {
                        e.addClass("pui-sortable-column").data("order", 0).append('<span class="pui-sortable-column-icon fa fa-fw fa-sort"></span>')
                    }
                })
            }
            ...
            if (this.options.paginator) {
                this.options.paginator.paginate = function (c, d) {
                    b.paginate()
                };
            ...
            var a = this;
            $.each(this.sortableColumns, function (b, c) {
                var e = $(c), d = e.data();
                if (a.options.sortField === d.field) {
                    var f = e.children(".pui-sortable-column-icon");
                    e.data("order", a.options.sortOrder).removeClass("ui-state-hover").addClass("ui-state-active");
                    if (a.options.sortOrder === -1) {
                        f.removeClass("fa-sort fa-sort-asc").addClass("fa-sort-desc")
                    } else {
                        if (a.options.sortOrder === 1) {
                            f.removeClass("fa-sort fa-sort-desc").addClass("fa-sort-asc")
                        }
                    }
                }
            })
            ...
            if (this.paginator) {
                this.paginator.puipaginator("setState", {page: 0, totalRecords: this.data.length})
            }
            ...
            var b = this, a = this.thead.find("> tr > th.pui-sortable-column");
            a.on("mouseover.puidatatable", function () {
                ...
                if (e === -1) {
                    g.removeClass("fa-sort fa-sort-asc").addClass("fa-sort-desc")
                } else {
                    if (e === 1) {
                        g.removeClass("fa-sort fa-sort-desc").addClass("fa-sort-asc")
                    }
                }
            })
        }, paginate: function () {
            ...
            if (this.data) {
                ...
                for (var d = e;
                    ...
                    var b = this.data[d];
                    if (b) {
                        var m = $('<tr class="ui-widget-content" />').appendTo(this.tbody), g = (d % 2 === 0) ? "pui-datatable-even" : "pui-datatable-odd", h = d;
                        m.addClass(g);
                        if (this.options.lazy) {
                            h += l
                        }
                        if (this.options.selectionMode && PUI.inArray(this.selection, h)) {
                            m.addClass("ui-state-highlight")
                        }
                        for (var c = 0;
                             c < this.options.columns.length;
                             c++) {
                            var a = $("<td />").appendTo(m), k = this.options.columns[c];
                            if (k.bodyClass) {
                                a.addClass(k.bodyClass)
                            }
                            if (k.bodyStyle) {
                                a.attr("style", k.bodyStyle)
                            }
                            if (k.content) {
                                var f = k.content.call(this, b);
                                if ($.type(f) === "string") {
                                    a.html(f)
                                } else {
                                    a.append(f)
                            ...
                            if (this.options.responsive && k.headerText) {
                                a.prepend('<span class="pui-column-title">' + k.headerText + "</span>")
                            }
                        }
                    }
                }
        ...
        }, _onRowClick: function (f, e) {
            if (!$(f.target).is(":input,:button,a")) {
                var h = $(e), d = h.hasClass("ui-state-highlight"), g = f.metaKey || f.ctrlKey, b = f.shiftKey;
                if (d && g) {
                    this.unselectRow(h)
                } else {
                    if (this._isSingleSelection() || (this._isMultipleSelection() && !g && !b)) {
                        if (this._isMultipleSelection()) {
                            var c = this.getSelection();
                            for (var a = 0;
                                 a < c.length;
                                 a++) {
                                this._trigger("rowUnselect", null, c[a])
                            }
                        }
        ...
        }, selectRow: function (d, a, b) {
            var e = this._getRowIndex(d), c = this.data[e];
            d.removeClass("ui-state-hover").addClass("ui-state-highlight").attr("aria-selected", true);
            this._addSelection(e);
            if (!a) {
                if (this.options.lazy) {
                    c = this.data[e - this._getFirst()]
                }
                this._trigger("rowSelect", b, c)
            }
        }, getSelection: function () {
            var c = this.options.lazy ? this._getFirst() : 0, b = [];
            for (var a = 0;
                 a < this.selection.length;
                 a++) {
                if (this.data.length > this.selection[a] - c && this.selection[a] - c > 0) {
                    b.push(this.data[this.selection[a] - c])
                }
            }
            return b
            ...
            if (this.options.scrollWidth) {
                var a = this.theadClone.find("> tr > th.pui-sortable-column");
                a.each(function () {
        ...
        options: {
            ...
            if (this.data) {
                ...
                for (var c = h;
                    ...
                    var f = this.data[c];
                    if (f) {
                        if (c % this.options.columns === 0) {
                            g = $('<div class="pui-grid-row"></div>').appendTo(this.content)
                        }
            ...
            var a = {first: this._getFirst(), rows: this._getRows()};
            return a
...
$(function () {
    $.widget("primeui.puidialog", {
        options: {
            ...
            this.titlebar.append('<a class="pui-dialog-titlebar-icon ' + a + ' ui-corner-all" href="#" role="button"><span class="pui-icon fa fa-fw ' + b + '"></span></a>')
        }, _enableModality: function () {
            var b = this, a = $(document);
            this.modality = $('<div id="' + this.element.attr("id") + '_modal" class="ui-widget-overlay"></div>').appendTo(document.body).css({
                width: a.width(),
                height: a.height(),
            ...
            if (this.options.closeOnEscape) {
                $(document).on("keydown.dialog_" + this.element.attr("id"), function (d) {
                    var c = $.ui.keyCode, b = parseInt(a.element.css("z-index"), 10) === PUI.zindex;
            ...
            this.element.resizable({
                ...
                containment: "document",
                start: function (b, c) {
                    a.element.data("offset", a.element.offset())
                },
                stop: function (b, c) {
                    var d = a.element.data("offset");
            ...
            if (/(center|left|top|right|bottom)/.test(this.options.location)) {
                ...
                this.element.position({
                    my: "center", at: this.options.location, collision: "fit", of: window, using: function (f) {
            ...
            var b = this;
            if (this.minimized) {
                this.element.appendTo(this.parent).removeClass("pui-dialog-minimized").css({
                    position: "fixed",
                    "float": "none"
                });
                this._restoreState();
            ...
            var a = this;
            $(window).on(this.resizeNS, function (b) {
                if (b.target === window) {
                    a._initPosition()
                }
            })
    ...
    $.widget("primeui.puidropdown", {
        options: {
            ...
            for (var a = 0;
                 ...
                 a++) {
                var b = this.choices.eq(a), d = b.text(), c = this.options.content ? this.options.content.call(this, this.options.data[a]) : d;
...
$(function () {
    $.widget("primeui.puifieldset", {
        options: {toggleable: false, toggleDuration: "normal", collapsed: false}, _create: function () {
    ...
    $.widget("primeui.puigalleria", {
        options: {
            ...
            if (g !== this.options.activeIndex) {
                ...
                if (this.options.showFilmstrip) {
                    var c = this.frames.eq(this.options.activeIndex), e = this.frames.eq(g);
                    ...
                    if ((j === undefined || j === true)) {
                        var h = e.position().left, k = this.options.frameWidth + parseInt(e.css("margin-right"), 10), i = this.strip.position().left, d = h + i, f = d + this.options.frameWidth;
...
$(function () {
    $.widget("primeui.puigrowl", {
        options: {sticky: false, life: 3000}, _create: function () {
            var a = this.element;
...
$(function () {
    $.widget("primeui.puiinputtextarea", {
        options: {
            ...
            var b = '<div id="' + this.id + '_panel" class="pui-autocomplete-panel ui-widget-content ui-corner-all ui-helper-hidden pui-shadow"></div>', c = this;
            ...
            this.element.keyup(function (g) {
                ...
                var d = c.panel.is(":visible"), i = $.ui.keyCode, h;
                switch (j.which) {
                    case i.UP:
                    case i.LEFT:
                        if (d) {
                            h = c.items.filter(".ui-state-highlight");
...
$(function () {
    $.widget("primeui.puilightbox", {
        options: {iframeWidth: 640, iframeHeight: 480, iframe: false}, _create: function () {
            ...
            this.imageDisplay.load(function () {
                ...
                a.content.removeClass("pui-lightbox-loading").animate({
                    width: d.width(),
                    height: d.height()
                }, 500, function () {
                    d.fadeIn();
            ...
            this.navigators.hover(function () {
                ...
                if (d.hasClass("pui-lightbox-nav-left")) {
                    b = a.current === 0 ? a.links.length - 1 : a.current - 1;
                    a.links.eq(b).trigger("click")
                } else {
                    b = a.current == a.links.length - 1 ? 0 : a.current + 1;
                    a.links.eq(b).trigger("click")
                }
                c.preventDefault()
            });
            ...
            this.element.click(function (b) {
                if (!a.iframeLoaded) {
                    a.content.addClass("pui-lightbox-loading").css({
                        width: a.options.iframeWidth,
                        height: a.options.iframeHeight
                    });
                    a.show();
            ...
            this.modality = $('<div class="ui-widget-overlay"></div>').css({
                width: $(document).width(),
                height: $(document).height(),
...
$(function () {
    $.widget("primeui.puibasemenu", {
        options: {popup: false, trigger: null, my: "left top", at: "left bottom", triggerEvent: "click"},
        _create: function () {
        ...
        _initPopup: function () {
            ...
            this.options.trigger.on(this.options.triggerEvent + ".pui-menu", function (b) {
        ...
        options: {}, _create: function () {
            ...
            this.element.children("li").each(function () {
                ...
                if (c.children("h3").length > 0) {
                    ...
                    if (b) {
                        a.prepend('<span class="pui-menuitem-icon fa fa-fw ' + b + '"></span>')
                    }
                }
            });
    ...
    $.widget("primeui.puibreadcrumb", {
        _create: function () {
            ...
            this.element.children("li").each(function (b) {
                ...
                a.addClass("pui-menuitem-link ui-corner-all").contents().wrap('<span class="ui-menuitem-text" />');
                if (b > 0) {
                    c.before('<li class="pui-breadcrumb-chevron fa fa-chevron-right"></li>')
                } else {
                    c.before('<li class="fa fa-home"></li>')
                }
            })
        }
    })
...
$(function () {
    $.widget("primeui.puitieredmenu", $.primeui.puibasemenu, {
        options: {autoDisplay: true}, _create: function () {
            this._render();
...
$(function () {
    $.widget("primeui.puislidemenu", $.primeui.puibasemenu, {
        _create: function () {
            ...
            this.element.addClass("pui-menu-list ui-helper-reset").wrap('<div class="pui-menu pui-slidemenu ui-widget ui-widget-content ui-corner-all"/>').wrap('<div class="pui-slidemenu-wrapper" />').after('<div class="pui-slidemenu-backward ui-widget-header ui-corner-all">\n                    <span class="pui-icon fa fa-fw fa-caret-left"></span>Back</div>').wrap('<div class="pui-slidemenu-content" />');
            this.element.parent().uniqueId();
            this.options.id = this.element.parent().attr("id");
            this.element.find("li").each(function () {
...
$(function () {
    $.widget("primeui.puicontextmenu", $.primeui.puitieredmenu, {
        options: {autoDisplay: true, target: null, event: "contextmenu"}, _create: function () {
            this._super();
...
$(function () {
    $.widget("primeui.puimessages", {
        options: {closable: true}, _create: function () {
            ...
            this.msgContainer.append('<li><span class="pui-messages-summary">' + a.summary + '</span><span class="pui-messages-detail">' + a.detail + "</span></li>")
        }, clear: function () {
...
$(function () {
    $.widget("primeui.puinotify", {
        options: {position: "top", visible: false, animate: true, effectSpeed: "normal", easing: "swing"},
        _create: function () {
...
$(function () {
    $.widget("primeui.puipanel", {
        options: {
            ...
            var b = this;
            if (this.options.closable) {
                this.closer = $('<a class="pui-panel-titlebar-icon ui-corner-all ui-state-default" href="#"><span class="pui-icon fa fa-fw fa-close"></span></a>').appendTo(this.header).on("click.puipanel", function (d) {
                    b.close();
                    d.preventDefault()
                })
            }
            if (this.options.toggleable) {
                var a = this.options.collapsed ? "fa-plus" : "fa-minus";
                this.toggler = $('<a class="pui-panel-titlebar-icon ui-corner-all ui-state-default" href="#"><span class="pui-icon fa fa-fw ' + a + '"></span></a>').appendTo(this.header).on("click.puipanel", function (d) {
                    b.toggle();
                    d.preventDefault()
                });
                if (this.options.collapsed) {
...
$(function () {
    $.widget("primeui.puipassword", {
        options: {
            ...
            this.panel.css({left: "", top: "", "z-index": ++PUI.zindex}).position({
                my: "left top",
                at: "right top",
                of: this.element
            })
...
$(function () {
    $.widget("primeui.puipicklist", {
        options: {
        ...
        }, _createList: function (d, b, c, e) {
            d.wrap('<div class="ui-helper-hidden"></div>');
            var a = $('<div class="pui-picklist-listwrapper ' + b + '"></div>'), f = $('<ul class="ui-widget-content pui-picklist-list pui-inputtext"></ul>');
            if (this.options.filter) {
                a.append('<div class="pui-picklist-filter-container"><input type="text" class="pui-picklist-filter" /><span class="pui-icon fa fa-fw fa-search"></span></div>');
                a.find("> .pui-picklist-filter-container > input").puiinputtext()
            }
            if (c) {
                a.append('<div class="pui-picklist-caption ui-widget-header ui-corner-tl ui-corner-tr">' + c + "</div>");
            ...
            return f
        }, _populateContainerFromOptions: function (b, h, f) {
            var g = b.children("option");
            for (var c = 0;
                 c < g.length;
                 c++) {
                var a = g.eq(c), e = this.options.content ? this.options.content.call(this, f[c]) : a.text(), d = $('<li class="pui-picklist-item ui-corner-all">' + e + "</li>").data({
                    "item-label": a.text(),
                    "item-value": a.val()
                });
            ...
            a.append(this._createButton("fa-angle-right", "pui-picklist-button-add", function () {
                b._add()
            })).append(this._createButton("fa-angle-double-right", "pui-picklist-button-addall", function () {
                b._addAll()
            })).append(this._createButton("fa-angle-left", "pui-picklist-button-remove", function () {
                b._remove()
            })).append(this._createButton("fa-angle-double-left", "pui-picklist-button-removeall", function () {
                b._removeAll()
            }));
            this.element.append(a)
        }, _createListControls: function (b) {
            var c = this, a = $('<ul class="pui-picklist-buttons"></ul>');
            a.append(this._createButton("fa-angle-up", "pui-picklist-button-move-up", function () {
                c._moveUp(b)
            })).append(this._createButton("fa-angle-double-up", "pui-picklist-button-move-top", function () {
                c._moveTop(b)
            })).append(this._createButton("fa-angle-down", "pui-picklist-button-move-down", function () {
                c._moveDown(b)
            })).append(this._createButton("fa-angle-double-down", "pui-picklist-button-move-bottom", function () {
                c._moveBottom(b)
            }));
            return a
        }, _createButton: function (d, a, c) {
            var b = $('<button class="' + a + '" type="button"></button>').puibutton({
            ...
            this._unbindEvents();
            this.items.addClass("ui-state-disabled");
            this.element.find(".pui-picklist-buttons > button").each(function (a, b) {
                $(b).puibutton("disable")
            })
        }, enable: function () {
            this._bindEvents();
    ...
    $.widget("primeui.puiradiobutton", {
        _create: function () {
            ...
            this.element.focus(function () {
                ...
                if (a[c]) {
                    a[c].removeClass("ui-state-active ui-state-focus ui-state-hover").children(".pui-radiobutton-icon").removeClass("fa fa-fw fa-circle")
                }
...
$(function () {
    $.widget("primeui.puirating", {
        options: {stars: 5, cancel: true}, _create: function () {
            var b = this.element;
            b.wrap("<div />");
...
$(function () {
    $.widget("primeui.puispinner", {
        options: {step: 1}, _create: function () {
            ...
            var c, a = this.value ? this.value : 0;
            if (this.options.precision) {
                c = parseFloat(this._toFixed(a + b, this.options.precision))
            } else {
                c = parseInt(a + b, 10)
            }
            if (this.options.min !== undefined && c < this.options.min) {
                c = this.options.min
            }
            if (this.options.max !== undefined && c > this.options.max) {
                c = this.options.max
            }
...
$(function () {
    $.widget("primeui.puisplitbutton", {
        options: {icon: null, iconPos: "left", items: null}, _create: function () {
            ...
            for (var a = 0;
                 ...
                 a++) {
                var c = this.options.items[a], d = $('<li class="pui-menuitem ui-widget ui-corner-all" role="menuitem"></li>'), b = $('<a class="pui-menuitem-link ui-corner-all"><span class="pui-menuitem-icon fa fa-fw ' + c.icon + '"></span><span class="ui-menuitem-text">' + c.text + "</span></a>");
                if (c.url) {
                    b.attr("href", c.url)
                }
                if (c.click) {
...
$(function () {
    $.widget("primeui.puisticky", {
        _create: function () {
            this.initialState = {top: this.element.offset().top, height: this.element.height()};
            this.id = this.element.attr("id");
            if (!this.id) {
                this.id = this.element.uniqueId().attr("id")
            }
            ...
            var d = this, c = $(window), b = "scroll." + this.id, a = "resize." + this.id;
            c.off(b).on(b, function () {
                ...
                if (d.fixed) {
                    d.element.width(d.ghost.outerWidth() - (d.element.outerWidth() - d.element.width()))
                }
            })
        }, _fix: function () {
            if (!this.fixed) {
                this.element.css({position: "fixed", top: 0, "z-index": 10000}).addClass("pui-shadow pui-sticky");
            ...
            if (this.fixed) {
                this.element.css({position: "static", top: "auto", width: "auto"}).removeClass("pui-shadow pui-sticky");
                this.ghost.remove();
                this.fixed = false
            }
        }
...
$(function () {
    $.widget("primeui.puitabview", {
        options: {activeIndex: 0, orientation: "top"}, _create: function () {
            var a = this.element;
            ...
            this.navContainer.find("li .fa-close").on("click.tabview", function (c) {
...
$(function () {
    $.widget("primeui.puiterminal", {
        options: {welcomeMessage: "", prompt: "prime $", handler: null}, _create: function () {
...
$(function () {
    $.widget("primeui.puitogglebutton", {
        options: {onLabel: "Yes", offLabel: "No", onIcon: null, offIcon: null}, _create: function () {
            ...
            this.container.on("mouseover", function () {
                if (!a.container.hasClass("ui-state-active")) {
                    a.container.addClass("ui-state-hover")
                }
...
$(function () {
    $.widget("primeui.puitooltip", {
        options: {
            ...
            this.container.css({left: "", top: "", "z-index": ++PUI.zindex}).position({
                my: this.options.my,
                at: this.options.at,
                of: this.target
            })
...
$(function () {
    $.widget("primeui.puitree", {
        options: {nodes: null, lazy: false, animate: false, selectionMode: null, icons: null}, _create: function () {
...
$(function () {
    $.widget("primeui.puitreetable", {
        options: {nodes: null, lazy: false, selectionMode: null}, _create: function () {
            this.id = this.element.attr("id");
            if (!this.id) {
                this.id = this.element.uniqueId().attr("id")
            }
            ...
            if (this.options.columns) {
                $.each(this.options.columns, function (c, b) {
                    ...
                    if (b.headerClass) {
                        d.addClass(b.headerClass)
                    }
                    if (b.headerStyle) {
                        d.attr("style", b.headerStyle)
                    }
                    if (b.headerText) {
                        d.text(b.headerText)
                    }
            ...
            this._renderNodes(a, null, true)
        }, _renderNodes: function (a, r, l) {
            for (var h = 0;
                 h < a.length;
                 h++) {
                var d = a[h], c = d.data, n = this.options.lazy ? d.leaf : !(d.children && d.children.length), q = $('<tr class="ui-widget-content"></tr>'), g = r ? r.data("depth") + 1 : 0, o = r ? r.data("rowkey") : null, b = o ? o + "_" + h : h.toString();
                q.data({depth: g, rowkey: b, parentrowkey: o, puidata: c,});
                if (!l) {
                    q.addClass("ui-helper-hidden")
                }
                for (var f = 0;
                     f < this.options.columns.length;
                     f++) {
                    var e = $("<td />").appendTo(q), p = this.options.columns[f];
                    if (p.bodyClass) {
                        e.addClass(p.bodyClass)
                    }
                    if (p.bodyStyle) {
                        e.attr("style", p.bodyStyle)
                    }
                    if (f === 0) {
                        var k = $('<span class="pui-treetable-toggler pui-icon fa fa-fw fa-caret-right"></span>');
                ...
                if (r) {
                    ...
                    q.appendTo(this.tbody)
                }
                if (!n) {
                    this._renderNodes(d.children, q, d.expanded)
                }
            }
        }, _bindEvents: function () {
            var c = this, a = "> tr > td:first-child > .pui-treetable-toggler";
            this.tbody.off("click.puitreetable", a).on("click.puitreetable", a, null, function (f) {
                var d = $(this), g = d.closest("tr");
                if (!g.data("processing")) {
                    g.data("processing", true);
                    if (d.hasClass("fa-caret-right")) {
                        c.expandNode(g)
                    } else {
                        c.collapseNode(g)
                    }
            ...
            if (this.options.selectionMode) {
                this.selection = [];
                var b = "> tr";
                this.tbody.off("mouseover.puitreetable mouseout.puitreetable click.puitreetable", b).on("mouseover.puitreetable", b, null, function (f) {
                    var d = $(this);
                    if (!d.hasClass("ui-state-highlight")) {
                        d.addClass("ui-state-hover")
                    }
                }).on("mouseout.puitreetable", b, null, function (f) {
                    var d = $(this);
                    if (!d.hasClass("ui-state-highlight")) {
                        d.removeClass("ui-state-hover")
                    }
                }).on("click.puitreetable", b, null, function (d) {
                    c.onRowClick(d, $(this))
                })
            }
        }, expandNode: function (a) {
            ...
            this._renderNodes(b, a, true);
            this._showNodeChildren(a, false);
            a.data("puiloaded", true);
            this._trigger("afterExpand", null, {node: a, data: a.data("puidata")})
        }, _showNodeChildren: function (d, c) {
            if (!c) {
                d.data("expanded", true).attr("aria-expanded", true).find(".pui-treetable-toggler:first").addClass("fa-caret-down").removeClass("fa-caret-right")
            }
            ...
            for (var a = 0;
                ...
                if (e.data("expanded")) {
                    this._showNodeChildren(e, true)
                }
            }
            d.data("processing", false)
        }, collapseNode: function (a) {
            this._trigger("beforeCollapse", null, {node: a, data: a.data("puidata")});
            this._hideNodeChildren(a, false);
            a.data("processing", false);
            this._trigger("afterCollapse", null, {node: a, data: a.data("puidata")})
        }, _hideNodeChildren: function (d, c) {
            if (!c) {
                d.data("expanded", false).attr("aria-expanded", false).find(".pui-treetable-toggler:first").addClass("fa-caret-right").removeClass("fa-caret-down")
            }
            var b = this._getChildren(d);
            for (var a = 0;
                 a < b.length;
                ...
                if (e.data("expanded")) {
                    this._hideNodeChildren(e, true)
                }
            }
        }, onRowClick: function (b, d) {
            if ($(b.target).is("td,span:not(.ui-c)")) {
                var a = d.hasClass("ui-state-highlight"), c = b.metaKey || b.ctrlKey;
                if (a && c) {
                    this.unselectNode(d)
                } else {
                    if (this.isSingleSelection() || (this.isMultipleSelection() && !c)) {
                        this.unselectAllNodes()
                    }
                    this.selectNode(d)
                }
            ...
            if (!a) {
                this._trigger("nodeSelect", {}, {node: b, data: b.data("puidata")})
            }
        }, unselectNode: function (b, a) {
            b.removeClass("ui-state-highlight").attr("aria-selected", false);
            if (!a) {
                this._trigger("nodeUnselect", {}, {node: b, data: b.data("puidata")})
            }
        }, unselectAllNodes: function () {
            ...
            return this.options.selectionMode === "multiple"
        }, _getChildren: function (f) {
            var c = f.data("rowkey"), g = f.nextAll(), e = [];
            for (var d = 0;
                 d < g.length;
                 d++) {
                var a = g.eq(d), b = a.data("parentrowkey");
                if (b === c) {
                    e.push(a)
                }
            }
